...
class BananaAspectRatioNodeV2(comfy_io.ComfyNode):
    STANDARD_RATIOS = (
        ("16:9", 16 / 9),
        ("9:16", 9 / 16),
        ("4:3", 4 / 3),
    ...
    def define_schema(cls) -> comfy_io.Schema:
        return comfy_io.Schema(
            node_id="BananaAspectRatioV2",
            display_name="Banana Aspect Ratio V2",
            category="Banana",
            inputs=[
...
class BananaImageSizeAdapterNodeV2(comfy_io.ComfyNode):
    ...
    def define_schema(cls) -> comfy_io.Schema:
        return comfy_io.Schema(
            node_id="BananaImageSizeAdapterV2",
            display_name="Banana Image Size Adapter V2",
            category="Banana",
            inputs=[
                comfy_io.Image.Input("image"),
                comfy_io.Combo.Input("aspect_ratio", options=cls.RATIO_OPTIONS, default=AUTO_SIZE),
